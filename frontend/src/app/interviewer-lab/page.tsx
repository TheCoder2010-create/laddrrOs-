...
import type { NetsInitialInput, InterviewerAnalysisOutput, InterviewerConversationInput } from '../types/ai';
...
function LearnerView({ initialNomination, onUpdate }: { initialNomination: Nomination, onUpdate: () => void }) {
    ...
    const handleExitSimulation = async (messages?: { role: 'user' | 'model', content: string }[]) => {
        ...
        try {
            ...
            const analysisResult: InterviewerAnalysisOutput = await response.json();
