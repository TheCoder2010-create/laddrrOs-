...
"[project]/frontend/src/services/admin-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/backend/src/lib/role-mapping.ts [app-client] (ecmascript)");
'use client';
;
;
...
async function getAllUsers() {
    const allUserRoles = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]).filter((r)=>r !== 'Anonymous');
    return {
        all: allUserRoles
    };
}
...
"[project]/frontend/src/services/org-coaching-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__ = __turbopack_context__.i("[project]/node_modules/uuid/dist/esm-browser/v4.js [app-client] (ecmascript) <export default as v4>");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/services/admin-service.ts [app-client] (ecmascript)");
'use client';
;
;
...
async function assignCoachingFromOrgHealth(recommendations, assignerRole) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$admin$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAdminLogEntry"])(assignerRole, `Assigned ${newItems.length} new coaching tasks from Org Health analysis.`);
}
...
"[project]/frontend/src/services/feedback-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$org$2d$coaching$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/services/org-coaching-service.ts [app-client] (ecmascript)");
;
;
;
...
const getMockOneOnOneHistory = ()=>{
    const now = new Date();
    const leadName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]['Team Lead'].name;
    const employeeName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]['Employee'].name;
    return [
        {
            id: 'mock-1on1-1',
...
const getFromStorage = (key)=>{
    ...
    if (!json) {
        ...
        if (key === PRACTICE_SCENARIOS_KEY) {
            const mockData = getMockPracticeScenarios();
            saveToStorage(key, mockData);
            return mockData;
        }
        if (key === ONE_ON_ONE_HISTORY_KEY) {
            const mockData = getMockOneOnOneHistory();
            saveToStorage(key, mockData);
            return mockData;
        }
        return [];
...
async function assignPracticeScenario(assignedBy, assignedTo, scenario, persona, dueDate) {
    ...
    if (assignedBy !== 'System') {
        ...
        const assignerName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][assignedBy]?.name || assignedBy;
        const notification = {
...
async function completePracticeScenario(input, assignedScenarioId) {
    ...
    if (assignedScenarioId) {
        ...
        const userRole = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]).find((u)=>u.name === 'Casey Day')?.role || 'Employee';
...
async function getActiveCoachingPlansForUser(userNameOrRole) {
    const userName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][userNameOrRole]?.name || userNameOrRole;
    const userRole = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]).find((r)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][r].name === userName) || userNameOrRole;
    const history = await getOneOnOneHistory();
    const customPlans = getFromStorage(CUSTOM_COACHING_PLANS_KEY);
    const orgPlans = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$org$2d$coaching$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrgCoachingItems"])();
    const activePlans = [];
...
async function addCustomCoachingPlan(actor, data) {
    const supervisorName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][actor]?.name;
...
async function submitEmployeeFeedbackAcknowledgement(trackingId, accepted, comments) {
    ...
    if (accepted) {
        ...
        const lastResponderRole = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]).find((u)=>u.name === lastResponder)?.role || lastResponder;
    ...
    history.forEach((h)=>{
        if (h.analysis.actionItems) {
            h.analysis.actionItems.forEach((ai)=>{
                const ownerRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRoleByName"])(ai.owner);
...
async function getActionItemsForEmployee(employeeName) {
    const allItems = [];
    const employeeRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRoleByName"])(employeeName);
    // From 1-on-1s
    const history = await getOneOnOneHistory();
    history.forEach((h)=>{
...
async function getTeamActionItemStatus(supervisorRole) {
    const history = await getOneOnOneHistory();
    const supervisorName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][supervisorRole]?.name;
    const teamMembers = {};
    const now = new Date();
    history.forEach((item)=>{
...
async function getTeamNetsScores(supervisorRole) {
    ...
    allPractice.forEach((practice)=>{
        if (teamMemberRoles.includes(practice.assignedTo) && practice.status === 'completed' && practice.analysis) {
            const memberName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][practice.assignedTo]?.name;
...
async function getManagerDevelopmentMapData(amRole) {
    ...
    const teamLeadName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][teamLeadRole].name;
...
async function getTeamCoachingQualityIndex(amRole) {
    ...
    return Object.entries(qualityMap).map(([teamLeadName, data])=>({
        ...
        })).filter((item)=>item.teamLeadName === __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"]['Team Lead'].name); // Only show Team Lead for this demo
}
...
"[project]/frontend/src/services/interviewer-lab-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function nominateUser(managerRole, nomineeRole, targetRole) {
    ...
    const managerName = __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][managerRole]?.name || managerRole;
    const notification = {
    ...
    const allFeedback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFeedbackFromStorage"])();
    allFeedback.unshift(notification);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveFeedbackToStorage"])(allFeedback);
...
"[project]/frontend/src/services/leadership-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getFromStorage = (key)=>{
    ...
    if (!json) {
        if (key === LEADERSHIP_COACHING_KEY) {
            const mockData = getMockLeadershipData();
            saveToStorage(key, mockData);
            return mockData;
        }
        return [];
...
async function nominateForLeadership(managerRole, nomineeRole, targetRole, mentorRole) {
    ...
    // Create a notification for the nominated user
    const managerName = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["roleUserMapping"][managerRole]?.name || managerRole;
    const notification = {
...
//# sourceMappingURL=frontend_src_services_10817812._.js.map