...
"[project]/frontend/src/app/messages/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LeadershipPulseWidget({ item, onUpdate }) {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveFeedback"])(item.trackingId, role, resolutionMessage);
            toast({
...
_s(LeadershipPulseWidget, "XF3s2AbWOTRbbbOEHlz0Gw12H4k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
...
function GeneralNotificationWidget({ item, onUpdate }) {
    ...
    const handleAcknowledge = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveFeedback"])(item.trackingId, role, "Notification acknowledged.");
            toast({
...
_s1(GeneralNotificationWidget, "rILZfjj9KsCgxtLmc4KVwVIGfko=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$use$2d$role$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRole"]
    ];
});
_c1 = GeneralNotificationWidget;
function ConcernAcknowledgementWidget({ item, onUpdate }) {
    ...
    const handleAcknowledge = async (accepted)=>{
        setIsSubmitting(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitEmployeeFeedbackAcknowledgement"])(item.trackingId, accepted, comments);
            if (accepted) {
                toast({
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$role$2d$mapping$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatActorName"])(lastResponderEvent?.actor),
                                    "'s Response:"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/frontend/src/app/messages/page.tsx",
...
_s2(ConcernAcknowledgementWidget, "ix4QNuNF3sHuEBUJ5aGdyN48d/c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c2 = ConcernAcknowledgementWidget;
function MessagesContent({ role }) {
    _s3();
    const [activeMessages, setActiveMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [acknowledgedHistory, setAcknowledgedHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const fetchMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MessagesContent.useCallback[fetchMessages]": async ()=>{
            setIsLoading(true);
            const feedback = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$feedback$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllFeedback"])();
            const userActiveMessages = [];
            const userAcknowledgedHistory = [];
            feedback.forEach({
                "MessagesContent.useCallback[fetchMessages]": (item)=>{
            ...
            }["MessagesContent.useCallback[fetchMessages]"]);
            userActiveMessages.sort({
                "MessagesContent.useCallback[fetchMessages]": (a, b)=>new Date(b.submittedAt).getTime() - new Date(a.submittedAt).getTime()
            }["MessagesContent.useCallback[fetchMessages]"]);
            userAcknowledgedHistory.sort({
                "MessagesContent.useCallback[fetchMessages]": (a, b)=>new Date(b.submittedAt).getTime() - new Date(a.submittedAt).getTime()
            }["MessagesContent.useCallback[fetchMessages]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesContent.useEffect": ()=>{
            ...
            const handleDataUpdate = {
                "MessagesContent.useEffect.handleDataUpdate": ()=>{
                    fetchMessages();
                }
            }["MessagesContent.useEffect.handleDataUpdate"];
    ...
    const renderWidgets = (item)=>{
        ...
        if (item.surveyQuestions) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LeadershipPulseWidget, {
                item: item,
        ...
        if (item.status === 'Pending Acknowledgement') {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GeneralNotificationWidget, {
                item: item,
                onUpdate: fetchMessages
        ...
        if (item.status === 'Pending Employee Acknowledgment') {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ConcernAcknowledgementWidget, {
                item: item,
                onUpdate: fetchMessages
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                ...
                                                                children: [
                                                                    "Acknowledged on: ",
                                                                    item.auditTrail?.find((e)=>e.event === 'Acknowledged')?.timestamp ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(item.auditTrail.find((e)=>e.event === 'Acknowledged').timestamp), 'PPP p') : 'N/A'
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/frontend/src/app/messages/page.tsx",
                                                                lineNumber: 318,
...
_s3(MessagesContent, "C8qxUsw8AYR82O0tDys+3fD7PaQ=");
_c3 = MessagesContent;
function MessagesPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$dashboard$2d$layout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MessagesContent, {
            role: role
        }, void 0, false, {
            fileName: "[project]/frontend/src/app/messages/page.tsx",
            lineNumber: 360,
...
_s4(MessagesPage, "++8NurmX72afF0DrgJVO+AGlFZ8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$use$2d$role$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRole"]
    ];
});
...
__turbopack_context__.k.register(_c, "LeadershipPulseWidget");
__turbopack_context__.k.register(_c1, "GeneralNotificationWidget");
__turbopack_context__.k.register(_c2, "ConcernAcknowledgementWidget");
__turbopack_context__.k.register(_c3, "MessagesContent");
__turbopack_context__.k.register(_c4, "MessagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=frontend_src_53f584bf._.js.map