...
function statusOrFromError(error) {
    ...
    return {
        ...
        error: Object.assign(Object.assign({}, error), {
            metadata: (_a = error.metadata) !== null && _a !== void 0 ? _a : new metadata_1.Metadata()
        })
    };
}
...
function getChannelzServiceDefinition() {
     ...
     * runtime for users who will not use/enable channelz. */ const loaderLoadSync = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/node_modules/@grpc/proto-loader/build/src/index.js [app-route] (ecmascript)").loadSync;
...
"[project]/node_modules/@grpc/grpc-js/build/src/single-subchannel-channel.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
class SingleSubchannelChannel {
    constructor(subchannel, target, options){
        ...
        this.filterStackFactory = new filter_stack_1.FilterStackFactory([
            new compression_filter_1.CompressionFilterFactory(this, options)
        ]);
    }
    close() {
        if (this.channelzEnabled) {
...
exports.SingleSubchannelChannel = SingleSubchannelChannel; //# sourceMappingURL=single-subchannel-channel.js.map
}}),
...
const subchannel_address_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/subchannel-address.js [app-route] (ecmascript)");
const channelz_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/channelz.js [app-route] (ecmascript)");
const single_subchannel_channel_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/single-subchannel-channel.js [app-route] (ecmascript)");
     ...
     */ startResolution() {
        ...
        if (this.dnsHostname === null) {
            ...
            this.pendingLookupPromise.then((addressList)=>{
                 ...
                 * can update the service config by using the same address list */ const healthStatus = this.listener(this.latestLookupResult, {}, this.latestServiceConfigResult, '');
             ...
             * that result when it comes in */ if (this.isServiceConfigEnabled && this.pendingTxtPromise === null) {
                ...
                this.pendingTxtPromise.then((txtRecord)=>{
                    ...
                    if (this.latestLookupResult !== null) {
                         ...
                         * should result in a fast and seamless switchover. */ this.listener(this.latestLookupResult, {}, this.latestServiceConfigResult, '');
                    }
                }, (err)=>{
    ...
    createSession(secureConnectResult, address, options) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            const sessionOptions = {
                 ...
                 * by disabling the check entirely. */ maxSessionMemory: (_e = options['grpc-node.max_session_memory']) !== null && _e !== void 0 ? _e : Number.MAX_SAFE_INTEGER
            };
...
class RetryingCall {
    ...
    getNextRetryJitter() {
        /* Jitter of +-20% is applied: https://github.com/grpc/proposal/blob/master/A6-client-retries.md#exponential-backoff */ return Math.random() * (1.2 - 0.8) + 0.8;
    }
...
"[project]/node_modules/@grpc/grpc-js/build/src/orca.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
function loadOrcaProto() {
    ...
    /* The purpose of this complexity is to avoid loading @grpc/proto-loader at
     * runtime for users who will not use/enable ORCA. */ const loaderLoadSync = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/node_modules/@grpc/proto-loader/build/src/index.js [app-route] (ecmascript)").loadSync;
...
function createOrcaClient(channel) {
    ...
    return new ClientClass('unused', channel_credentials_1.ChannelCredentials.createInsecure(), {
...
class OobMetricsDataProducer {
    ...
    updateMetricsSubscription() {
        ...
        if (!this.metricsCall || newInterval !== this.currentInterval) {
            ...
            const metricsCall = this.client.streamCoreMetrics({
                report_interval: (0, duration_1.msToDuration)(newInterval)
            });
...
const logging = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/logging.js [app-route] (ecmascript)");
const tls_1 = __turbopack_context__.r("[externals]/tls [external] (tls, cjs)");
const orca_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/orca.js [app-route] (ecmascript)");
 ...
 */ class LeafLoadBalancer {
    ...
    startConnecting() {
        this.pickFirstBalancer.updateAddressList((0, call_interface_1.statusOrFromValue)([
            this.endpoint
...
var call_interface_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/call-interface.js [app-route] (ecmascript)");
...
var internal_channel_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/internal-channel.js [app-route] (ecmascript)");
...
"[project]/node_modules/@grpc/grpc-js/build/src/priority-queue.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
exports.PriorityQueue = PriorityQueue; //# sourceMappingURL=priority-queue.js.map
}}),
"[project]/node_modules/@grpc/grpc-js/build/src/load-balancer-weighted-round-robin.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const orca_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/orca.js [app-route] (ecmascript)");
const picker_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/picker.js [app-route] (ecmascript)");
const priority_queue_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/priority-queue.js [app-route] (ecmascript)");
const subchannel_address_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/subchannel-address.js [app-route] (ecmascript)");
...
class WeightedRoundRobinPicker {
    ...
    pick(pickArgs) {
        ...
        this.queue.push(Object.assign(Object.assign({}, entry), {
        ...
        if (childPick.pickResultType === picker_1.PickResultType.COMPLETE) {
            if (this.metricsHandler) {
                return Object.assign(Object.assign({}, childPick), {
                    onCallEnded: (0, orca_1.createMetricsReader)((loadReport)=>this.metricsHandler(loadReport, entry.endpointName), childPick.onCallEnded)
                });
            } else {
...
class WeightedRoundRobinLoadBalancer {
    ...
    calculateAndUpdateState() {
        ...
        /* round_robin should keep all children connected, this is how we do that.
          * We can't do this more efficiently in the individual child's updateState
          * callback because that doesn't have a reference to which child the state
          * change is associated with. */ for (const { child } of this.children.values()){
            if (child.getConnectivityState() === connectivity_state_1.ConnectivityState.IDLE) {
                child.exitIdle();
            }
        }
...
var orca_1 = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/orca.js [app-route] (ecmascript)");
...
const load_balancer_weighted_round_robin = __turbopack_context__.r("[project]/node_modules/@grpc/grpc-js/build/src/load-balancer-weighted-round-robin.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40grpc_grpc-js_d0c75999._.js.map